...
public class TradeMCPluginLoader implements PluginLoader {
    ...
    public void classloader(PluginClasspathBuilder pluginClasspathBuilder) {
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("xyz.xenondevs.invui:invui-kotlin:pom:1.44"), null));
